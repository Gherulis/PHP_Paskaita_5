...
<body>
    ...
    <h4>PDF failo ikelimas, nedidesnis nei 1 mb.</h4>
...
<?php 
    ...
    if(isset($_POST["upload"])) {
        ...
        //parduotuve
        //sql
        $failoPavadinimas = $_POST["file_name"];
        ...
        //failo pletini
        $file_extension =  strtolower($file_name_array[count($file_name_array)-1]);
        ...
        if($file_extension == "pdf" && $file_size <= 1){
